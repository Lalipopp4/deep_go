...
type Handler[T, K any] func(data []T, action func(T) K) []T

func Produce[T, K any](data []T, action func(T) K, f Handler[T, K]) []T {
	if data == nil {
		return nil
	}
...
func TestProduce(t *testing.T) {
	data := []int{1, 2, 3}
	res := Produce(data, func(v int) int { return v * 2 }, Map)
